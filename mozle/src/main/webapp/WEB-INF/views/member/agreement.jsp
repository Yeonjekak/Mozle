...
<div class="body">
	...
	<div class="join_title">
		...
		<div><span class="desc">회원이 되셔서 회원등급할인/할인쿠폰/적립금 등 다양한 서비스를 받으세요</span></div>
	</div>
	...
	<div style="border-top:2px solid #e8e8e8; background:#f7f7f7; border-bottom:2px solid #e8e8e8; padding-bottom:20px;">
		<div style="padding:5px 0px;text-align:center;font-color:#5e5e5e;line-height:12px;">
			<div style="margin-top:12px; font:1.6em Dotum; color:#494949; letter-spacing:-1px; font-weight:bold">신규회원을 위한 혜택을 놓치지 마세요!</div>
		</div>
		<table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:auto">
			<tr>
				<td>
				- <b>적립금</b> : <span style="font:1.2em Verdana; color:#c40000; font-weight:bold; letter-spacing:-1px">2,000</span>원
				</td>
			</tr>
		</table>
	</div>
	...
	<br><br/>
		...
		<div class="snsjoin">
			<ul class="sns_list">
<li> <img src="/mozle/resources/mozle_data/data/skin/0727zerom/images/sns/sns_bt_facebook_join.gif" class="jointypesns hand" snstype="fb"  alt="페이스북" title="페이스북 아이디로 회원가입" /></li><li>
 <img src="/mozle/resources/mozle_data/data/skin/0727zerom/images/sns/sns_bt_twitter_join.gif" class="jointypesns hand" snstype="tw"  alt="트위터" title="트위터 아이디로 회원가입" /></li><li> 
 <div></div>
	...
	var naverLogin = new naver.LoginWithNaverId(
			{
				...
				callbackHandle: true,
				loginButton: {color: "green", type: 4, height: 40} /* 로그인 버튼의 타입을 지정 */
			}
		);
		...
		window.addEventListener('load', function () {
			naverLogin.getLoginStatus(function (status) {
				if (status) {
					...
					alert(email);
					location.href="naverLogin.do?email="+email;
				} else {
